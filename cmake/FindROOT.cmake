...
#  REMOVE_FROM_LIST(root_flags "${root_libs_all}" "${root_library}")
  ...
  SET(ROOT_LIBRARIES ${root_flags} -lSpectrum  -lRooFit -lRooFitCore -lMathMore -lHistPainter -lTMVA)
...
#  MESSAGE("BLA: ${bla}")
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       ...
       ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} -p ${INFILES} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
